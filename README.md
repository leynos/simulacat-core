...
| --- | --- | --- |
| REST routes | Installations, repository lists, branches, blobs, trees, commit status, authenticated user, and org memberships | See [`docs/api-reference.md`](docs/api-reference.md) for the exact route list and [`docs/users-guide.md`](docs/users-guide.md#121--request-scoped-actor-resolution) for authenticated-user actor requirements. |
